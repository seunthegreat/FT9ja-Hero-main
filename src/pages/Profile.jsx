  ...
  return (
    <div className='flex relative'>
      ...
      > 
        ...
        <div className='flex flex-col px-10 xs:px-5 sm:mt-20 ss:mt-10 xs:mt-5'>
          <h2 className="sm:mt-10 xs:mt-20 lg:text-4xl md:text-3xl sm:text-2xl xs:text-xl font-bold">
            Profile
          </h2>
          <div className='my-10 rounded-[5px] border overflow-hidden'>
            <img src={profileBanner} className="h-[100%]" alt="Profile banner" />
