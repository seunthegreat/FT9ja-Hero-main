const styles = {
    ...
    heading: "font-poppins font-semibold xs:text-[38px] text-[30px] text-black xs:leading-[76.8px] w-full",
  ...
  export const layout = {
    ...
    sectionItems: `flex-1 flex ${styles.flexCenter} md:ml-10 ml-0 md:mt-0 mt-10 relative 
      grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4`,
